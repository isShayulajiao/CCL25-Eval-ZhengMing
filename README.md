...
点击报名链接填写报名表 https://f.wps.cn/g/BYw3bQEo/ 进行报名，我们会发送邮件确认您已经参赛。本次评测提供的**ZhengMing评测基准**的[语料](https://account.virtaicloud.com/gemini_web/auth/login)以及[代码](https://account.virtaicloud.com/gemini_web/auth/login)均放置在**驱动云**AI训练平台上。  
